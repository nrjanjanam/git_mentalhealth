...
typedef BottomNavBarChildBuilder = Widget Function(
...
class AnimationInfo {
  ...
  /// sides.
  double get radiansPerSide => 2 * math.pi / numSides;
...
/// Container for the state of a [BottomNavBar]'s animation, useful for syncing
...
/// is required.
///
/// [BottomNavBar] has two named constructors, `children` and `iconData`, and
...
///
/// [BottomNavBar] is a [StatelessWidget] that wraps an internal
...
class BottomNavBar extends StatelessWidget {
  ...
  final BottomNavBarChildBuilder? builder;
  ...
  /// [BottomNavBar] to manage your tabs' colors. Pass this or [children].
...
class _BottomNavBarInner extends StatefulWidget {
  final List<Color>? activeBadgeColors;
  final List<Color>? activeIconColors;
  final int activeIndex;
  final Curve animationCurve;
  ...
  @override
  _BottomNavBarInnerState createState() => _BottomNavBarInnerState();
}

class _BottomNavBarInnerState extends State<_BottomNavBarInner>
  ...
  void _spinOutInActiveIndicator(AnimationInfo? info,
    ...
    double totalRadiansToRotate = 2 * math.pi * 2;
  ...
  Color _getActiveIconColor() {
    if (widget.activeIconColors == null) {
      return lighten(color: widget.indicatorColors[colorIndex], amount: 0.3)!;
    }
  ...
  Color _getBadgeColor(int index) {
    ...
    return activeIndex == index
        ? lighten(color: widget.indicatorColors[colorIndex], amount: 0.3)!
  ...
  void didUpdateWidget(Widget oldWidget) {
    super.didUpdateWidget(oldWidget as _BottomNavBarInner);
...
Color? lighten({@required Color? color, double amount = 0.1}) {
